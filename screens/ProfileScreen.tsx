  ...
  return (
    <div className="min-h-screen p-4 flex flex-col bg-gray-50">
      <div className="flex-grow flex items-center justify-center">
        ...
        <div className="bg-white w-full max-w-sm rounded-[40px] shadow-2xl p-8 flex flex-col max-h-[750px] relative z-10">
          ...
          <button 
            ...
            className="w-full py-4 mt-6 rounded-full font-bold text-lg transition-colors bg-gray-100 hover:bg-gray-200 text-gray-800"
          >
            Sign out
          </button>
        </div>
